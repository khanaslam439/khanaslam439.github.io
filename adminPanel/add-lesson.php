                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5 align-items-center">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fs-3 mb-1">Add lesson</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                        <div class="card-body py-3">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-5">
                                        <label class="mb-2">Sub Category Name</label>
                                        <input type="text" disabled class="form-control" value="Sub-Category-1" placeholder="enter category name" />
                                    </div>
                                    <div class="mb-5">
